...
const Footer: React.FC = () => {
    return (
        <footer className="w-full fixed bottom-0 left-0 right-0 bg-gradient-to-b from-yellow-400 to-black py-12">
            <div className="container mx-auto px-4 md:px-6">
                {/* Company Name */}
                <div className="text-center mb-10">
                    <h1 className="text-6xl md:text-[10rem] lg:text-[12rem] font-extrabold text-white tracking-wide drop-shadow-[0_4px_10px_rgba(0,0,0,0.4)]">
                        ATLAS
                    </h1>
                </div>
